...
public class CourseServiceImpl implements CourseService {
    ...
    public Optional<Course> save(CourseDto courseDto) {
        Teacher teacher=this.teacherRepository.findById(courseDto.getTeacher()).orElseThrow(()-> new TeacherNotFoundException(courseDto.getTeacher()));


        return Optional.of(this.courseRepository.save(new Course(courseDto.getName(), courseDto.getDescription(), teacher)));
    ...
    public Optional<Course> edit(Long id, CourseDto courseDto) {
        Course course = this.courseRepository.findById(id).orElseThrow(CourseNotFound::new);
        course.setName(courseDto.getName());
        course.setDescription(courseDto.getDescription());
        Teacher teacher = this.teacherRepository.findById(courseDto.getTeacher())
                .orElseThrow(() -> new TeacherNotFoundException(courseDto.getTeacher()));
