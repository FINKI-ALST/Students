...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public Optional<Student> save(String username, String password, String name) {

        return Optional.of(this.studentRepository.save(new Student(username, password, name)));
